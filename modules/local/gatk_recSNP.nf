process GATK_RECSNP {
    ...
    output:
    tuple val(id), path("MERGED_VQSR1_SNP.recal"), emit: recsnp_recal
    tuple val(id), path("MERGED_VQSR1_SNP.tranches"), emit: recsnp_tranches
    tuple val(id), path("MERGED_VQSR1_SNP.model"), emit: recsnp_model
    ...
    -O MERGED_VQSR1_SNP.recal \\
    --tranches-file MERGED_VQSR1_SNP.tranches \\
    --output-model MERGED_VQSR1_SNP.model 
    """
}
